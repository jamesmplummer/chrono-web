...
export const Key = memo((props: KeyProps) => {
    ...
    <>
      ...
      <div className='sm:hidden'>
        <button
          ref={modalButtonRef}
          onClick={onKeyToggle}
          className='relative flex h-9 w-11 cursor-pointer items-center justify-center rounded-[4px] bg-gradient-to-r from-slate-700 to-slate-800 p-1.5 text-slate-200'
        >
          <KeyIcon size={24} />
